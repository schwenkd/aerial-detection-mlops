...
### Step-0: to start go to ec2 box
```
  go to aerial-detection-docker-compose-prometheus-and-grafana directory
  git pull https://github.com/dnautiyal/aerial-detection-docker-compose-prometheus-and-grafana.git
  docker-compose up -d
  docker-compose down
```
