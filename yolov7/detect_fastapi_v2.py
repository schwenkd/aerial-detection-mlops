...
class Yolov7Detect:
    def __init__(self, model_weights = 'yolov7.pt', device = 'cpu'):
        print("Initialize the new instance of Yolov7Detect Model.")
    ...
    def detect(self, source, output, image_size = 640):
    ...
    #    (save_dir / 'labels' if save_txt else save_dir).mkdir(parents=True, exist_ok=True)  # make dir
        ...
        for path, img, im0s, vid_cap in dataset:
            ...
            for i, det in enumerate(pred):  # detections per image
                ...
                p = Path(p)  # to Path
                save_path = str(save_dir.split('.')[0])  # img.jpg
                txt_path = str(save_path)# + ('')  # img.txt
